import json
# input_file = "F:\\MASC\\Jali_sing\\\Revision\\Lip Sync live performances\\and i\\reference_vocals_jali_MVP.json"
...
def init_blend_nodes():
    ...
    vowel_mod_sliders = [["Dimple", "Dimple"], ["Pucker", "Pucker"],
                         ...
                         ["Oo_pointer", "lipPucker"], ["U_pointer", "lipPucker"], ["U_pointer", "jaw_open"],
                         ["Ah_pointer", "jaw_open"], ["Eh_pointer", "jaw_open"], ["Oo_pointer", "jaw_open"],
                         ["Ee_pointer", "jaw_open"]]
