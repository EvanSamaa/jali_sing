...
input_file_template = "E:/MASC/lmbmm_vocal_sep_data/NUS/test/{}.json"
out_file_template = "E:/MASC/lmbmm_vocal_sep_data/NUS/test_landmarks/{}_raw.json"
for i in range(0, 4):
    ...
    time_frame = math.ceil(data["t_max"] * 24)
