...
if __name__ == "__main__":
    ...
    # for re-training
    model.load_state_dict(torch.load("../../Dataset/viseme_net_model/model_epoch_650.pt")['model_state_dict'])
    loss_fn = torch.nn.CrossEntropyLoss()
    optimizer = optim.Adam(model.parameters(), lr=0.00001)
    # for re-training
    optimizer.load_state_dict(torch.load("../../Dataset/viseme_net_model/model_epoch_650.pt")['optimizer_state_dict'])
    epochs = 10000
